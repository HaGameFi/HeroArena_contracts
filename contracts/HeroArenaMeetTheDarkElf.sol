 ...
 */
contract HeroArenaMeetTheDarkElf is AccessControl, Ownable {
    ...
    function initLevels() external onlyOwner {
        ...
        HeroArenaChallengesSC.setLevelNameAndRewardPoints(8, "Pull Me Around", 10);
        HeroArenaChallengesSC.setLevelNameAndRewardPoints(9, "Nom Nom Nom", 10);
        HeroArenaChallengesSC.setLevelNameAndRewardPoints(10, "Knight Crossing", 15);
        HeroArenaChallengesSC.setLevelNameAndRewardPoints(11, "Hard Target", 20);
        HeroArenaChallengesSC.setLevelNameAndRewardPoints(12, "Choices, Choices", 25);
        HeroArenaChallengesSC.setLevelNameAndRewardPoints(13, "Three Vs. Thress", 15);
        HeroArenaChallengesSC.setLevelNameAndRewardPoints(14, "Let's Be Bad", 25);
